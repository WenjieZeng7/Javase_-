...
//        users.add(new User(1, false,"张三", "正常", new BigDecimal(("100"))));
//        users.add(new User(2,false, "李四", "正常", new BigDecimal(("100"))));
//        users.add(new User(3,false, "王五", "正常", new BigDecimal(("100"))));
